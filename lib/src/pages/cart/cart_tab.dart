...
import 'package:curso_flutter_greengrocer/src/pages/cart/components/cart_tile.dart';
...
class _CartTabState extends State<CartTab> {
  ...
  void removeItemFromCart(CartItemModel cartItem) {
    setState(() {
      ...
      ultilsServices.showToast(message: '${cartItem.item.itemName} removido do carrinho');
    });
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ultilsServices.priceToCurrency(cartTotalPrice()),
                style: TextStyle(
                  fontSize: 23,
                  ...
                  onPressed: () async {
                    ...
                    if (result ?? false) {
                      showDialog(
                        context: context,
                        builder: (_) {
                          return PaymenteDialog(
                            order: appData.orders.first,
                          );
                        },
                      );
                    } else {
                      ultilsServices.showToast(message: 'Pedido não confirmado');
                    }
                  },
                  child: const Text(
                    'Concluir pedido',
